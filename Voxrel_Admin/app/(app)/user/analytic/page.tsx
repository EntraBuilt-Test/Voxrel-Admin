...
export default function UserAnalyticPage() {
    ...
    if (error) {
        return (
            <div className="min-h-screen flex flex-col px-4 gap-4">
                <FilterBar
                    showSearch={false}
                ...
                <div className="flex-1 flex items-center justify-center border-2 border-dashed rounded-xl bg-muted/30">
                    <div className="text-center">
                        ...
                        {error && <p className="text-sm text-muted-foreground mt-2">{error instanceof Error ? error.message : String(error)}</p>}
                    </div>
                </div>
            </div>
        );
        ...
        <div className="max-h-screen flex flex-col px-4 gap-4">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">Track user performance, growth trends, and top performers across the platform.</p>
                </div>
                <FilterBar
                    showSearch={false}
                    filters={ANALYTICS_FILTERS_CONFIG}
